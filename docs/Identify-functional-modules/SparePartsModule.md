...
- [Level 8 continuous improvement & analytics view](../../Diagrams/DataFlow/Level8/SparePartsManagement-Level8.md) — showcases demand forecasting, supplier scorecards, and margin analytics fuelling policy, procurement, and pricing optimisation.
